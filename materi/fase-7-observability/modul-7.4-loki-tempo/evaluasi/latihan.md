...
1. 1. Logs, labels, dan LogQL: tulis ringkasan konsep, ownership, failure mode, dan evidence field.
2. 2. Traces dan correlation: buat contoh non-secret atau query/config static dengan placeholder.
3. LAB-01 Loki: lengkapi Lane A static dan acceptance criteria.
4. LAB-02 Tempo/correlation: susun Lane B optional disposable dengan context verification, approval, stop condition, rollback, cleanup, dan evidence redacted.
