...
1. 1. Arsitektur dan remote-write: tulis ringkasan konsep, ownership, failure mode, dan evidence field.
2. 2. Retention, HA, dan recovery: buat contoh non-secret atau query/config static dengan placeholder.
3. LAB-01 remote-write/query: lengkapi Lane A static dan acceptance criteria.
4. LAB-02 capacity/recovery: susun Lane B optional disposable dengan context verification, approval, stop condition, rollback, cleanup, dan evidence redacted.
