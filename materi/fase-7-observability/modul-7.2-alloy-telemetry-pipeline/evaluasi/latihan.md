...
1. 1. Pipeline tiga pilar: tulis ringkasan konsep, ownership, failure mode, dan evidence field.
2. 2. OTLP, DaemonSet, dan debugging: buat contoh non-secret atau query/config static dengan placeholder.
3. LAB-01 remote-write: lengkapi Lane A static dan acceptance criteria.
4. LAB-02 logs/OTLP: susun Lane B optional disposable dengan context verification, approval, stop condition, rollback, cleanup, dan evidence redacted.
