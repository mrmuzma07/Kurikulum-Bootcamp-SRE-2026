# Latihan Grafana/Alerting/SLO

## Tugas

1. 1. Dashboard USE/RED: tulis ringkasan konsep, ownership, failure mode, dan evidence field.
2. 2. Alert route/notification: buat contoh non-secret atau query/config static dengan placeholder.
3. LAB-01 dashboard: lengkapi Lane A static dan acceptance criteria.
4. LAB-02 alert/failure injection: susun Lane B optional disposable dengan context verification, approval, stop condition, rollback, cleanup, dan evidence redacted.
